...
# Initials
df = n_gram(df, input_col='forename_clean', output_col='forename_init', missing_value='-9', n=1)
df = n_gram(df, input_col='last_name_clean', output_col='last_name_init', missing_value='-9', n=1)

# Trigrams
df = n_gram(df, input_col='forename_clean', output_col='forename_tri', missing_value='-9', n=3)
df = n_gram(df, input_col='last_name_clean', output_col='last_name_tri', missing_value='-9', n=3)

# Soundex
df = soundex(df, input_col='forename_clean', output_col='forename_sdx', missing_value='-9')
df = soundex(df, input_col='last_name_clean', output_col='last_name_sdx', missing_value='-9')
