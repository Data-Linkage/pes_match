...
def test_get_residuals(df):
    ...
    result_1 = get_residuals(
        all_records=test_all_records_1, matched_records=df, id_column="puid_1"
    )
    result_2 = get_residuals(
        all_records=test_all_records_2, matched_records=df, id_column="puid_2"
    )
